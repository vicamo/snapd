...
###PROFILEATTACH### (attach_disconnected,mediate_deleted) {
  ...
  owner @{HOME}/.local/share/snap/@{SNAP_INSTANCE_NAME}/ r,
  owner @{HOME}/.local/share/snap/@{SNAP_INSTANCE_NAME}/** mrkix,

  # Writable home area for this version.
  # bind mount *not* used here (see 'parallel installs', above)
  owner @{HOME}/.local/share/snap/@{SNAP_INSTANCE_NAME}/@{SNAP_REVISION}/** wl,
  owner @{HOME}/.local/share/snap/@{SNAP_INSTANCE_NAME}/common/** wl,
