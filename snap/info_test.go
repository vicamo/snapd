...
func (s *infoSuite) testDirAndFileMethods(c *C, info snap.PlaceInfo) {
	...
	c.Check(info.UserDataDir("/home/bob"), Equals, "/home/bob/.local/share/snap/name/1")
	c.Check(info.UserCommonDataDir("/home/bob"), Equals, "/home/bob/.local/share/snap/name/common")
	...
	c.Check(info.DataHomeDir(), Equals, "/home/*/.local/share/snap/name/1")
	c.Check(info.CommonDataHomeDir(), Equals, "/home/*/.local/share/snap/name/common")
...
func (s *infoSuite) testInstanceDirAndFileMethods(c *C, info snap.PlaceInfo) {
	...
	c.Check(info.UserDataDir("/home/bob"), Equals, "/home/bob/.local/share/snap/name_instance/1")
	c.Check(info.UserCommonDataDir("/home/bob"), Equals, "/home/bob/.local/share/snap/name_instance/common")
	...
	// XXX: Those are actually a globs, not directories
	c.Check(info.DataHomeDir(), Equals, "/home/*/.local/share/snap/name_instance/1")
	c.Check(info.CommonDataHomeDir(), Equals, "/home/*/.local/share/snap/name_instance/common")
...
func (s *infoSuite) TestDirAndFileHelpers(c *C) {
	...
	c.Check(snap.UserDataDir("/home/bob", "name", snap.R(1)), Equals, "/home/bob/.local/share/snap/name/1")
	c.Check(snap.UserCommonDataDir("/home/bob", "name"), Equals, "/home/bob/.local/share/snap/name/common")
	c.Check(snap.UserXdgRuntimeDir(12345, "name"), Equals, "/run/user/12345/snap.name")
	c.Check(snap.UserSnapDir("/home/bob", "name"), Equals, "/home/bob/.local/share/snap/name")
	...
	c.Check(snap.UserDataDir("/home/bob", "name_instance", snap.R(1)), Equals, "/home/bob/.local/share/snap/name_instance/1")
	c.Check(snap.UserCommonDataDir("/home/bob", "name_instance"), Equals, "/home/bob/.local/share/snap/name_instance/common")
	c.Check(snap.UserXdgRuntimeDir(12345, "name_instance"), Equals, "/run/user/12345/snap.name_instance")
	c.Check(snap.UserSnapDir("/home/bob", "name_instance"), Equals, "/home/bob/.local/share/snap/name_instance")
}
